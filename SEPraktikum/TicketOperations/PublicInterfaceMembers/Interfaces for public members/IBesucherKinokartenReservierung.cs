namespace TicketOperations.InterfaceMembers
{
    interface IBesucherKinokartenReservierung : IKinokarteReservieren
    {
        ...
        /// <remarks></remarks>
        int TicketReservieren(IPublicVorstellung vorstellung, ISitzIdentifikator sitz, bool rabatt, IKinokarteBlockierungZugangsSchlüssel transaktionsSchlüssel);
        ...
        /// <remarks></remarks>
        int TicketReservieren(IPublicKinokarte kinokarte, bool rabatt, IKinokarteBlockierungZugangsSchlüssel transaktionsSchlüssel);
    }
}
